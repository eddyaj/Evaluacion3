...
public class Steps {
	...
	@Given("Abrir Login")
	 public void abrir_Chrome() {
		 ...
		 System.setProperty("webdriver.chrome.driver", "C:\\Users\\eduardoAcevedo\\Downloads\\chromedriver\\chromedriver.exe");
		 driver = new ChromeDriver();
		 driver.manage().window().maximize();
		 driver.get("http://localhost:8080/EVALUACION_2A_EDUARDO_ACEVEDO/Index.jsp");
	}
